...
export const MsciAnalyst = () => {
	return (
		<div className="text-start mt-4" style={{ maxWidth: "700px", margin: "0 auto" }}>
			<h4>Analyst:</h4>
			<strong>Jun 2019 - Dec 2021</strong>

			<p>
				Worked as a <strong>Software Engineer (Backend)</strong> in the ESG Engineering Department.
			...
			<ul style={{ listStyle: "none", paddingLeft: 0 }}>
				<li>
					<TrophyIcon />
					"Star of the Month" Team Award for contribution to the ESG rating model enhancement
					project in Q4-2020.
				</li>
			</ul>
			...
			<ul style={{ listStyle: "none", paddingLeft: 0 }}>
				<li>
					<FireIcon /> Point of Contact from the Developers Team for Production Issues. (During the
					March and April monthly release sprint, 2021)
				</li>
				<li>
					<FireIcon /> Deployments of multiple apps for March and April releases.
				</li>
			</ul>
			...
			<ul style={{ listStyle: "none", paddingLeft: 0 }}>
				...
				<li>
					<CheckIcon />
					Rating Model Enhancement (RME) - Corporate Behavior and Governance Pillar (2020-21){" "}
					<TrophyIcon />
				</li>
				<li>
					<CheckIcon />
